package de.yaya.yayconfig.mojangOptions.widgets;
...
public class ButtonListWidget extends ElementListWidget<ButtonListWidget.ButtonEntry> {
	...
	public ClickableWidget getButtonFor(Option option) {
		...
		do {
			...
			ButtonEntry buttonEntry = (ButtonEntry)var2.next();
	...
	public Optional<ClickableWidget> getHoveredButton(double mouseX, double mouseY) {
		...
		while(var5.hasNext()) {
			ButtonEntry buttonEntry = (ButtonEntry)var5.next();
	...
	protected static class ButtonEntry extends ElementListWidget.Entry<ButtonEntry> {
		...
		public static ButtonEntry create(GameOptions options, int width, Option firstOption, @Nullable Option secondOption) {
			...
			return secondOption == null ? new ButtonEntry(ImmutableMap.of(firstOption, clickableWidget)) : new ButtonEntry(ImmutableMap.of(firstOption, clickableWidget, secondOption, secondOption.createButton(options, width / 2 - 155 + 160, 0, 150)));
		}
